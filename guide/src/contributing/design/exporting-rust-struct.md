...
#[export_name = "foo_new"]
pub extern "wasm-bindgen" fn __wasm_bindgen_generated_Foo_new(arg0: i32) -> u32
    let ret = Foo::new(arg0);
    Box::into_raw(Box::new(WasmRefCell::new(ret))) as u32
}

#[export_name = "foo_get"]
pub extern "wasm-bindgen" fn __wasm_bindgen_generated_Foo_get(me: u32) -> i32 {
...
#[export_name = "foo_set"]
pub extern "wasm-bindgen" fn __wasm_bindgen_generated_Foo_set(me: u32, arg1: i32) {
    let me = me as *mut WasmRefCell<Foo>;
    wasm_bindgen::__rt::assert_not_null(me);
    let me = unsafe { &*me };
...
#[no_mangle]
pub unsafe extern "wasm-bindgen" fn __wbindgen_foo_free(me: u32) {
    let me = me as *mut WasmRefCell<Foo>;
    wasm_bindgen::__rt::assert_not_null(me);
